...
const mantras = ["ॐ पितृदेवताभ्यो नमः", "ॐ नमः शिवाय", "ॐ नारायणाय नमः"];

const effects: Effect[] = [
  {
    icon: Users,
    title: "Removal of Ancestral Blockages",
    items: ["Brings peace to ancestors and removes hidden karmic burdens"],
  },
  {
    icon: Users,
    title: "Improved Family Happiness",
    items: ["Reduces disputes and brings unity"],
  },
  {
    icon: TrendingUp,
    title: "Financial Stability",
    items: ["Removes repeated obstacles and losses"],
  },
  {
    icon: Heart,
    title: "Marriage & Relationship Relief",
    items: ["Ideal for delayed marriage and relationship instability"],
  },
  {
    icon: Heart,
    title: "Health & Emotional Peace",
    items: ["Helps overcome chronic health issues and mental stress"],
  },
  {
    icon: Sparkles,
    title: "Divine Blessings",
    items: ["Increases fortune, luck, and overall positivity"],
  },
];
...
const types: TypeItem[] = [
  {
    ...
    description:
      "Primary ritual to remove Pitra Dosh and bring peace to ancestors.",
    image: "/pitra-dosh-shanti.png",
    icon: "🙏",
  },
  {
    name: "Narayan Bali",
    description:
      "Powerful ritual to release unsatisfied ancestral souls and remove karmic blockages.",
    image: "/pitra-dosh-shanti.png",
    icon: "🕉️",
  },
  {
    ...
    description:
      "Performed for ancestors of last three generations to provide peace to wandering souls.",
    image: "/pitra-dosh-shanti.png",
    icon: "⚡",
  },
  {
    name: "Nandi Shraddh",
    description:
      "Special shraddh ritual performed to honor and pacify departed ancestors.",
    image: "/pitra-dosh-shanti.png",
    icon: "🌟",
  },
  {
    ...
    description:
      "Ancestral offerings to satisfy departed souls and remove Pitra Dosh.",
    image: "/pitra-dosh-shanti.png",
    icon: "🕯️",
  },
];
...
const whyChoose: WhyChooseItem[] = [
  {
    ...
    description:
      "Expert in Trimbakeshwar ancestor rituals and karmic remedies.",
  },
  {
    icon: CheckCircle2,
    title: "Expert in Trimbakeshwar Ancestor Rituals",
    description:
      "Specialized knowledge in Pitra Dosh and ancestral karma remedies.",
  },
  {
    icon: BookOpen,
    title: "Accurate Vedic Mantras & Procedure",
    description:
      "Performed with complete Vedic rituals and proper mantras for maximum relief.",
  },
  {
    icon: TrendingUp,
    title: "Affordable Packages",
    description:
      "Complete arrangements with transparent pricing and no hidden charges.",
  },
  {
    icon: UserCheck,
    title: "Support for Out-Station Devotees",
    description:
      "Complete assistance with stay, timing, and samagri arrangements.",
  },
  {
    icon: Clock,
    title: "Personalized Guidance",
    description:
      "Guru Ji suggests the correct puja after checking your kundli and family history.",
  },
];
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#FBDCAB" }}>
      ...
      <IntroSection
        ...
        descriptions={["Pitra Dosh appears in a kundli due to:"]}
