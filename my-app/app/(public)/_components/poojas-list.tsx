...
const poojaCategories = [
  ...
  {
    name: "Mahamrutunjay Jaap",
    nameHindi: "महामृत्युंजय जाप",
    poojas: [
      {
    ...
    poojas: [
      {
        ...
        descriptionHindi:
          "पितृ दोष और पूर्वजों के कर्मिक मुद्दों को दूर करने के लिए शक्तिशाली 3-दिवसीय अनुष्ठान",
      ...
      },
      {
        ...
        description:
          "Pacify ancestors and remove Pitra Dosh for family harmony",
        descriptionHindi:
          "पूर्वजों को शांत करें और परिवार की सद्भाव के लिए पितृ दोष दूर करें",
        image: "/tripindi.jpg",
        href: "/tripindi",
        icon: HeartHandshake,
      },
      {
        ...
        description:
          "Remove ancestral curses and bring blessings from ancestors",
        descriptionHindi:
          "पैतृक श्राप दूर करें और पूर्वजों से आशीर्वाद प्राप्त करें",
  ...
  },
  {
    ...
    poojas: [
      ...
      },
      {
        ...
        descriptionHindi:
          "ग्रहों की ऊर्जा को संतुलित करें और नकारात्मक ग्रह प्रभावों को कम करें",
      ...
      },
      {
        ...
        description:
          "Neutralize harmful yogs and restore balance in your kundli",
        descriptionHindi:
          "हानिकारक योगों को निष्क्रिय करें और अपनी कुंडली में संतुलन बहाल करें",
      ...
      },
      {
        ...
        description:
          "Calm your birth star and remove negative Nakshatra effects",
        descriptionHindi:
          "अपने जन्म नक्षत्र को शांत करें और नकारात्मक नक्षत्र प्रभावों को दूर करें",
      ...
      },
      {
        ...
        description:
          "Remove negative energies from your home, office, or property",
        descriptionHindi:
          "अपने घर, कार्यालय या संपत्ति से नकारात्मक ऊर्जा दूर करें",
            ...
            >
              {index === activeTab && (
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle at 50% 50%, #FBDCAB 0%, transparent 70%)",
                    animation: "pulse 2s ease-in-out infinite",
                  }}
                />
              )}
              <span className="relative z-10 block">{category.name}</span>
              <span className="relative z-10 block text-sm mt-1">
                {category.nameHindi}
              </span>
            </button>
          ))}
            ...
            return (
              <Link key={index} href={pooja.href}>
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(251, 220, 171, 0.1) 0%, rgba(255, 255, 255, 0.05) 100%)",
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, rgba(155, 37, 30, 0.1) 0%, rgba(251, 220, 171, 0.1) 100%)",
                    }}
                  />
                  ...
                  <div
                    ...
                    style={{
                      ...
                      padding: "2px",
                      background:
                        "linear-gradient(135deg, #9B251E, #FBDCAB, #9B251E)",
                      WebkitMask:
                  ...
                  <div className="relative z-10 p-6">
                      ...
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        >
                          ...
                          <div
                            ...
                            style={{
                              background:
                                "radial-gradient(circle at center, rgba(251, 220, 171, 0.3) 0%, transparent 70%)",
                            }}
                          />
                        </div>
                    ...
                    <div
                      ...
                      style={{
                        background:
                          "radial-gradient(circle, #9B251E 0%, transparent 70%)",
                        borderRadius: "50%",
                    ...
                    <div
                      ...
                      style={{
                        background:
                          "radial-gradient(circle, #FBDCAB 0%, transparent 70%)",
                        borderRadius: "50%",
                        transform: "translate(-30%, 30%)",
                      }}
                    />
