  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          Connect with Pandit Kartike Guru Ji for authentic Vedic puja services
          at Trimbakeshwar. Experience the power of traditional rituals and find
          peace in your life.
        </p>
        <p
        ...
        >
          त्र्यंबकेश्वर में प्रामाणिक वैदिक पूजा सेवाओं के लिए पंडित कार्तिके
          गुरु जी से जुड़ें। पारंपरिक अनुष्ठानों की शक्ति का अनुभव करें और अपने
          जीवन में शांति पाएं।
        </p>
        ...
        <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4 mb-8">
          ...
          >
            <span className="text-sm sm:text-base" style={{ color: "#FBDCAB" }}>
              Book Your Puja Now
            </span>
            <span
          ...
          >
            <Phone
              ...
              style={{ color: "#9B251E" }}
            />
            <span className="text-sm sm:text-base" style={{ color: "#9B251E" }}>
              Call: +91 8208780240
            </span>
          </Button>
          <Button
