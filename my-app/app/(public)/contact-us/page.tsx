    ...
    <div className="min-h-screen" style={{ backgroundColor: "#FBDCAB" }}>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            >
              Connect with Acharya Kartike Guru Ji for authentic Vedic puja
              services at Trimbakeshwar. We're here to guide you on your
              spiritual journey.
            </p>
          </div>
        </div>
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <Card
            className="border-2"
            style={{ borderColor: "#9B251E", backgroundColor: "#FBDCAB" }}
          >
            <CardContent className="pt-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={formData.poojaService}
                    onValueChange={(value) =>
                      setFormData({ ...formData, poojaService: value })
                    }
                  >
                    <SelectTrigger
