...
const services = [
  {
    ...
    description:
      "Remove obstacles caused by Kaal Sarp Dosh and restore peace in life",
    icon: Shield,
  ...
  },
  {
    ...
    description:
      "Powerful 3-day ritual to remove Pitra Dosh and ancestral karmic issues",
    icon: Star,
  ...
  },
  {
    ...
    description: "Pacify ancestors and remove Pitra Dosh for family harmony",
    icon: HeartHandshake,
    href: "/tripindi",
    color: "#9B251E",
  },
  ...
  },
  {
    ...
    description:
      "Balance planetary energies and reduce negative planetary effects",
    icon: Moon,
    href: "/grah-shanti",
    color: "#9B251E",
  },
...
const whyTrust = [
  {
    ...
    description:
      "Performed thousands of successful pujas with proven results. With decades of experience, Guru Ji has helped countless devotees overcome life obstacles through authentic Vedic rituals.",
    icon: "🏆",
    image: "/vastu-1.png",
  },
  {
    ...
    description:
      "Authorized priest recognized for authentic Vedic knowledge. Certified by Trimbakeshwar Temple Trust, ensuring all rituals follow traditional and sacred procedures.",
    icon: "✅",
    image: "/vastu-1.png",
  },
  {
    name: "Accurate Vidhi",
    description:
      "Every puja is done as per Puranic and Vedic traditions. Complete adherence to ancient scriptures ensures maximum spiritual benefits and divine blessings.",
    icon: "📖",
    image: "/vastu-1.png",
  },
  {
    ...
    description:
      "Guru Ji provides detailed explanations and remedies for each devotee. Every puja is personalized based on your horoscope and specific needs.",
    icon: "👤",
    image: "/vastu-1.png",
  },
  {
    ...
    description:
      "No hidden charges, complete support throughout your visit. Transparent pricing with affordable packages for all devotees.",
    icon: "💰",
    image: "/vastu-1.png",
  },
  {
    ...
    description:
      "Attend in person or join via video call. Flexible options to participate in pujas from anywhere in the world.",
    icon: "📱",
    image: "/vastu-1.png",
  },
];
      ...
      <div className="space-y-6">
        <div className="transition-all duration-500 ease-in-out">
          ...
          <p
            ...
            style={{ color: "#FBDCAB", opacity: 0.95 }}
          >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              >
                Your Trusted Vedic Priest for Kaal Sarp Dosh, Narayan Nagbali,
                Pitra Dosh, Tripindi, and Shanti Pujas
              </p>
              <p
                className="text-base sm:text-lg leading-relaxed"
                style={{ color: "#9B251E", opacity: 0.85 }}
              >
                Acharya Kartike Guru Ji is one of the most respected and
                experienced Vedic priests in Trimbakeshwar Jyotirlinga,
                specializing in all major Shanti Pujas including Kaal Sarp Dosh
                Puja, Narayan Nagbali, Tripindi Shraddh, Mahamrityunjay Jaap,
                Pitra Dosh Shanti, Vastu Shanti, Grah Shanti, Nakshatra Shanti,
                and Yog Shanti.
              </p>
              <p
                className="text-base sm:text-lg leading-relaxed"
                style={{ color: "#9B251E", opacity: 0.85 }}
              >
                With over 20+ years of experience, Guru Ji has guided thousands
                of devotees from India and across the world, helping them
                overcome life obstacles through ancient and authentic Vedic
                rituals.
              </p>
              <p
                className="text-base sm:text-lg leading-relaxed"
                style={{ color: "#9B251E", opacity: 0.85 }}
              >
                He is known for his humility, deep spiritual knowledge, accurate
                mantra chanting, and pure devotion toward Lord Shiva.
              </p>
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <Button
                  ...
                  onClick={() =>
                    window.open("https://wa.me/917888012103", "_blank")
                  }
                >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p
              ...
              style={{ color: "#FBDCAB", opacity: 0.9 }}
            >
              We provide authentic, affordable, and result-oriented puja
              services at Trimbakeshwar.
            </p>
            <p
              className="text-base max-w-3xl mx-auto mb-8"
              style={{ color: "#FBDCAB", opacity: 0.85 }}
            >
          ...
          <div className="mt-12 text-center">
            <Card
              className="inline-block border-2 px-8 py-6"
              style={{ borderColor: "#FBDCAB", backgroundColor: "#FBDCAB" }}
            >
              <p className="text-lg font-semibold" style={{ color: "#9B251E" }}>
                Every puja is performed with strict adherence to Vedic
                scriptures, Shastras, and Trimbakeshwar temple traditions.
              </p>
            </Card>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p
              ...
              style={{ color: "#9B251E", opacity: 0.9 }}
            >
              Acharya Kartike Guru Ji specializes in authentic Vedic rituals
              performed with devotion and expertise
            </p>
            <p
              className="text-base max-w-2xl mx-auto"
              style={{ color: "#9B251E", opacity: 0.85 }}
            >
              Each puja is performed with complete Vedic procedures, proper
              mantras, and pure samagri at Trimbakeshwar Jyotirlinga
            </p>
          </div>
            ...
            {services.map((service, index) => {
              ...
              return (
                <Link key={index} href={service.href}>
                  <Card
                    className="border-2 transition-all hover:scale-105 hover:shadow-2xl h-full group cursor-pointer"
                    ...
                    <CardHeader className="pb-4">
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <ArrowRight
                          ...
                          style={{ color: "#9B251E", opacity: 0.6 }}
                        />
                      </div>
                      <CardTitle
          ...
          <div className="text-center">
            ...
            >
              <p className="text-lg font-semibold" style={{ color: "#9B251E" }}>
                We perform all rituals with dedication, proper mantras, and
                complete samagri.
              </p>
            </Card>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p
              ...
              style={{ color: "#FBDCAB", opacity: 0.9 }}
            >
              Experience the difference of authentic Vedic rituals performed
              with devotion and expertise
            </p>
          </div>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p
            ...
            style={{ color: "#9B251E", opacity: 0.9 }}
          >
            We aim to bring peace, protection, prosperity, and spiritual healing
            to every devotee who seeks blessings at Trimbakeshwar.
          </p>
          <p
            className="text-base sm:text-lg leading-relaxed"
            style={{ color: "#9B251E", opacity: 0.85 }}
          >
            Our goal is to make every ritual meaningful, powerful, and
            life-transforming.
          </p>
